...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold text-saffron-800 mb-8">Add New Scripture</h1>

        <form action="{{ route('scriptures.store') }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-md p-6">
            @csrf
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="name" id="name" class="w-full rounded-lg border-gray-300" required>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="author" id="author" class="w-full rounded-lg border-gray-300">
                    </div>
                    <div>
                        <label for="time_period" class="block text-sm font-medium text-gray-700 mb-2">Time Period</label>
                        <input type="text" name="time_period" id="time_period" class="w-full rounded-lg border-gray-300">
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea name="description" id="description" rows="4" class="w-full rounded-lg border-gray-300" required></textarea>
                    </div>
                    <div>
                        <label for="significance" class="block text-sm font-medium text-gray-700 mb-2">Significance</label>
                        <textarea name="significance" id="significance" rows="4" class="w-full rounded-lg border-gray-300" required></textarea>
                    </div>
                    <div>
                        <label for="summary" class="block text-sm font-medium text-gray-700 mb-2">Summary</label>
                        <textarea name="summary" id="summary" rows="4" class="w-full rounded-lg border-gray-300" required></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <textarea name="original_text" id="original_text" rows="6" class="w-full rounded-lg border-gray-300" required></textarea>
                    </div>
                    <div>
                        <label for="transliteration" class="block text-sm font-medium text-gray-700 mb-2">Transliteration</label>
                        <textarea name="transliteration" id="transliteration" rows="6" class="w-full rounded-lg border-gray-300" required></textarea>
                    </div>
                    <div>
                        <label for="translation" class="block text-sm font-medium text-gray-700 mb-2">Translation</label>
                        <textarea name="translation" id="translation" rows="6" class="w-full rounded-lg border-gray-300" required></textarea>
                    </div>
                    <div>
                        <label for="commentary" class="block text-sm font-medium text-gray-700 mb-2">Commentary</label>
                        <textarea name="commentary" id="commentary" rows="6" class="w-full rounded-lg border-gray-300"></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-8">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="file" name="featured_image" id="featured_image" class="w-full" accept="image/*" required>
                    </div>
                    <div>
                        <label for="audio_recitations" class="block text-sm font-medium text-gray-700 mb-2">Audio Recitations</label>
            ...
            <div class="mb-8">
                ...
                <div id="chapters-container">
                    <div class="flex items-center space-x-4 mb-4">
                        ...
                        <button type="button" class="text-saffron-600 hover:text-saffron-700" onclick="addChapter()">
            ...
            <div class="mb-8">
                <label class="flex items-center">
                    <input type="checkbox" name="is_featured" class="rounded border-gray-300 text-saffron-600">
