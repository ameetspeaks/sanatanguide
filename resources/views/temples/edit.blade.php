...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <h1 class="text-3xl font-bold text-saffron-800 mb-8">Edit Temple: {{ $temple->name }}</h1>

        <form action="{{ route('temples.update', $temple) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg shadow-lg p-8">
            @csrf
            @method('PUT')
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $temple->name) }}" required
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">{{ old('description', $temple->description) }}</textarea>
                            @error('description')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="deity" id="deity" value="{{ old('deity', $temple->deity) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                            @error('deity')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <textarea name="address" id="address" rows="2" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">{{ old('address', $temple->address) }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="city" id="city" value="{{ old('city', $temple->city) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                            @error('city')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="state" id="state" value="{{ old('state', $temple->state) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                            @error('state')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="pincode" id="pincode" value="{{ old('pincode', $temple->pincode) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                            @error('pincode')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" step="any" name="latitude" id="latitude" value="{{ old('latitude', $temple->latitude) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                            @error('latitude')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" step="any" name="longitude" id="longitude" value="{{ old('longitude', $temple->longitude) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                            @error('longitude')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="time" name="opening_time" id="opening_time" value="{{ old('opening_time', $temple->opening_time) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                            @error('opening_time')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="time" name="closing_time" id="closing_time" value="{{ old('closing_time', $temple->closing_time) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                            @error('closing_time')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="number" name="darshan_duration" id="darshan_duration" value="{{ old('darshan_duration', $temple->darshan_duration) }}" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                    ...
                    <div class="mt-4 space-y-4">
                        <div class="flex items-center">
                            <input type="checkbox" name="special_darshan_available" id="special_darshan_available" value="1"
                                {{ old('special_darshan_available', $temple->special_darshan_available) ? 'checked' : '' }}
                        ...
                        <div id="special_darshan_fee_container" class="{{ old('special_darshan_available', $temple->special_darshan_available) ? '' : 'hidden' }}">
                            <label for="special_darshan_fee" class="block text-sm font-medium text-gray-700">Special Darshan Fee (₹)</label>
                            <input type="number" step="0.01" name="special_darshan_fee" id="special_darshan_fee" value="{{ old('special_darshan_fee', $temple->special_darshan_fee) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <textarea name="dress_code" id="dress_code" rows="2"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">{{ old('dress_code', $temple->dress_code) }}</textarea>
                            @error('dress_code')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="rules" id="rules" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">{{ old('rules', implode("\n", $temple->rules ?? [])) }}</textarea>
                            @error('rules')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="facilities" id="facilities" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">{{ old('facilities', implode("\n", $temple->facilities ?? [])) }}</textarea>
                            @error('facilities')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="history" id="history" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">{{ old('history', $temple->history) }}</textarea>
                            @error('history')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="architecture" id="architecture" rows="4"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">{{ old('architecture', $temple->architecture) }}</textarea>
                            @error('architecture')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <input type="text" name="contact_number" id="contact_number" value="{{ old('contact_number', $temple->contact_number) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
                    ...
                    <div class="space-y-4">
                        ...
                        @if($temple->featured_image)
                            <div class="mb-4">
                                ...
                                <img src="{{ Storage::url($temple->featured_image) }}" alt="Current Featured Image" class="h-48 w-auto rounded-lg">
                            </div>
                        @endif

                        <div>
                            <label for="featured_image" class="block text-sm font-medium text-gray-700">New Featured Image</label>
                        ...
                        @if($temple->gallery && count($temple->gallery) > 0)
                            <div class="mb-4">
                        ...
                        <div>
                            <label for="gallery" class="block text-sm font-medium text-gray-700">New Gallery Images</label>
                ...
                <div class="md:col-span-2">
                    <div class="flex items-center">
                        <input type="checkbox" name="is_featured" id="is_featured" value="1"
                            {{ old('is_featured', $temple->is_featured) ? 'checked' : '' }}
                            class="rounded border-gray-300 text-saffron-600 shadow-sm focus:border-saffron-500 focus:ring focus:ring-saffron-200">
